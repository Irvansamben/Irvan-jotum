...
public class OnBoardingScreen extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setTitle("Ml kamu gak naik naik rank nya?????");
        itemPayOnline.setDescription("lanjutkan buat mencari solusinya.");
        itemPayOnline.setImage(R.drawable.gambar1);

        OnboardingItem itemOnTheWay = new OnboardingItem();
        itemOnTheWay.setTitle("masih bingung!!!!");
        itemOnTheWay.setDescription("yuk gabung dan menjadi bagian dari jotum");
        itemOnTheWay.setImage(R.drawable.gambar2);

        OnboardingItem itemService = new OnboardingItem();
        itemService.setTitle("joki terbaik sepanjang masa");
        itemService.setDescription("silahkan daftarkan diri anda dan mulai menjadi bagian kami");
